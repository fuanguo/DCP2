function Opt=DCP_readOpt(handles)
    ...
    contents=cellstr(get(handles.subType,'String'));
    Opt.pipeline.type=contents{type};
    ...
    contents=cellstr(get(handles.InvertPop,'String'));
    Opt.tracktography.invert=contents{invert};
    swap=get(handles.SwapPop, 'Value');
    contents=cellstr(get(handles.SwapPop,'string'));
    Opt.tracktography.swap=contents{swap};
